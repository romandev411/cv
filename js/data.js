      ...
      list: [
        {
          company: {
            title: 'Компанія',
            text: 'Ribs',
            link: 'https://ribs.studio/',
            linkText: 'ribs.studio/',
          },
          period: {
            title: 'Період',
            text: 'Січ 2023 - Жовт 2023 (9міс.)',
          },
          responsibilities: {
            title: "Обов'язки",
            text: 'Розробка проектів з нуля. Підтримка та розширення існуючих проектів.',
          },
          technologies: {
            title: 'Технології',
            text: 'HTML/CSS, js, nuxt2',
          },
        },
        {
          company: {
      ...
      list: [
        {
          ...
          period: {
            title: 'Period',
            text: 'January 2023 - October 2023 (9 months)',
          },
          responsibilities: {
            title: "Обов'язки",
            text: 'Development of projects from scratch. Support and expansion of existing projects.',
          },
          technologies: {
            title: 'Technologies',
            text: 'HTML/CSS, js, nuxt2',
